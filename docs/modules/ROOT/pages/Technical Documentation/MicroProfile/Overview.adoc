...
Version 7.0 brought the most impactful changes when upgrading from 6.1: MicroProfile Metrics was removed from the platform and replaced by MicroProfile Telemetry 2.0, which provides a unified observability solution covering tracing, metrics, and logging under the OpenTelemetry umbrella. In addition, Fault Tolerance was updated to 4.1, OpenAPI to 4.0, and Rest Client to 4.0 — all of which include breaking changes that may require migration work.
...
This is supported by Payara Platform Enterprise starting from release *TBD* onwards
...
* https://download.eclipse.org/microprofile/microprofile-fault-tolerance-4.1/microprofile-fault-tolerance-spec-4.1.html[Fault Tolerance 4.1]
...
* https://download.eclipse.org/microprofile/microprofile-open-api-4.1/microprofile-openapi-spec-4.1.html[OpenAPI 4.1]
* https://download.eclipse.org/microprofile/microprofile-rest-client-4.0/microprofile-rest-client-spec-4.0.html[Rest Client 4.0]
* https://download.eclipse.org/microprofile/microprofile-telemetry-2.1/microprofile-telemetry-spec-2.1.html[Telemetry 2.1]
| [source, xml]
----
<dependency>
